...
export function coreElementFactory
    <InputType extends FunctionalElement | string, OutputType extends FunctionalElement>
    (HtmlConstructorType: { new(attributes: {}, _children: OutputType[]): OutputType}) {
...
export function transformToTextNodes
    <InputType extends FunctionalElement | string, OutputType extends FunctionalElement>
    (args1: InputType[]): OutputType[] {
